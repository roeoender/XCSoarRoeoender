...
Look::InitialiseConfigured(const UISettings &settings,
                           const Font &map_font, const Font &map_bold_font, const Font &map_overlay_value_font, const Font &map_overlay_medium_font,
                           unsigned infobox_width)
{
  ...
  map.Initialise(settings.map, map_font, map_bold_font, map_overlay_value_font, map_overlay_medium_font);
  icon.Initialise();
